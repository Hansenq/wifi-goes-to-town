...
ipcl_B :: IPClassifier(src host MY_GATEWAY && dst host AP3 && dst udp port 55001 && src udp port 55001
                     , -
                     );

//ipcl_C :: IPClassifier(src host MY_CLIENT, -);
...
f_wlan1
    -> Align(4, 0)
    -> downlink_tee
    -> UDPIPEncap(AP3, 55002, MY_GATEWAY, 55002)
    -> EtherEncap(0x0800, AP3, MY_GATEWAY)
    -> que_lan;
